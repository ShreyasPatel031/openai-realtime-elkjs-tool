  ...
  return (
    <>
      ...
      <div 
        ...
        onClick={(e) => {
          // CRITICAL: When connector tool is active, prevent node selection completely
        ...
        onMouseDown={(e) => {
          // CRITICAL: When connector tool is active, prevent node selection on mousedown
          if (selectedTool === 'connector') {
            e.stopPropagation();
            e.preventDefault();
            e.nativeEvent.stopImmediatePropagation();
        ...
        onMouseUp={(e) => {
          // CRITICAL: When connector tool is active, prevent node selection on mouseup
          if (selectedTool === 'connector') {
            e.stopPropagation();
            e.preventDefault();
            e.nativeEvent.stopImmediatePropagation();
        ...
        onPointerDown={(e) => {
          // CRITICAL: When connector tool is active, prevent node selection on pointerdown
          if (selectedTool === 'connector') {
            e.stopPropagation();
            e.preventDefault();
          }
        ...
        onPointerUp={(e) => {
          // CRITICAL: When connector tool is active, prevent node selection on pointerup
          if (selectedTool === 'connector') {
            e.stopPropagation();
            e.preventDefault();
          }
